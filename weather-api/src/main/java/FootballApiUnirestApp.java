 ...
 */
public class FootballApiUnirestApp {
...
//        Arrays
//            .stream(args)
//            .forEach(id -> getLeaderTeamAsync(id, FootballApiUnirestApp::printTeam));
        ...
        leaderLeague1.thenAcceptAsync(FootballApiUnirestApp::printTeam);


        leaderLeague2.thenAcceptAsync(FootballApiUnirestApp::printTeam);
